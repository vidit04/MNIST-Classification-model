...
cost_train_2 = np.loadtxt('Case 3/layer2/Training_loss_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
cost_valid_2 = np.loadtxt('Case 3/layer2/Validation_loss_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
cost_test_2= np.loadtxt('Case 3/layer2/Test_loss_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
acc_training_2  = np.loadtxt('Case 3/layer2/Training_acc_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
...
#acc_validation_2 = np.loadtxt('Case 3/layer2/Validation_acc_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
acc_test_2 = np.loadtxt('Case 3/layer2/Test_acc_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
...
cost_train_1 = np.loadtxt('Case 3/layer1/Training_loss_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
cost_valid_1 = np.loadtxt('Case 3/layer1/Validation_loss_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
cost_test_1 = np.loadtxt('Case 3/layer1/Test_loss_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
acc_training_1 = np.loadtxt('Case 3/layer1/Training_acc_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
acc_validation_1 = np.loadtxt('Case 3/layer1/Validation_acc_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
acc_test_1 = np.loadtxt('Case 3/layer1/Test_acc_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
...
cost_train_0 = np.loadtxt('Case 3/layer0/Training_loss_for_0_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
cost_valid_0 = np.loadtxt('Case 3/layer0/Validation_loss_for_0_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
cost_test_0 = np.loadtxt('Case 3/layer0/Test_loss_for_0_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
acc_training_0 = np.loadtxt('Case 3/layer0/Training_acc_for_0_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
acc_validation_0 = np.loadtxt('Case 3/layer0/Validation_acc_for_0_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
acc_test_0 = np.loadtxt('Case 3/layer0/Test_acc_for_0_layer_relu_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_momentum_optimizer.csv', delimiter=',')
...
plt.title('Comparision SGD-Momentum Loss_Graph for 0 hidden layers')
plt.plot(x, aa, label='Training Loss SGD')
plt.plot(x, aa1, label='Validation Loss SGD')
plt.plot(x, aa2, label='Test Loss SGD')
plt.plot(x, a, label='Training Loss Momentum')
plt.plot(x, a1, label='Validation Loss Momentum')
plt.plot(x, a2, label='Test Loss Momentum')
...
plt.title('Comparision SGD-Momentum Loss_Graph for 1 hidden layers')
plt.plot(x, mm, label='Training Loss SGD')
plt.plot(x, mm1, label='Validation Loss SGD')
plt.plot(x, mm2, label='Test Loss SGD')
plt.plot(x, m, label='Training Loss Momentum')
plt.plot(x, m1, label='Validation Loss Momentum')
plt.plot(x, m2, label='Test Loss Momentum')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision SGD-Momentum Loss_Graph for 2 hidden layers')
plt.plot(x, yy, label='Training Loss SGD')
plt.plot(x, yy1, label='Validation Loss SGD')
plt.plot(x, yy2, label='Test Loss SGD')
plt.plot(x, y, label='Training Loss Momentum')
plt.plot(x, y1, label='Validation Loss Momentum')
plt.plot(x, y2, label='Test Loss Momentum')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision SGD-Momentum Accuracy_Graph for 0 hidden layers')
plt.plot(x, bb, label='Training Acc SGD')
plt.plot(x, bb1, label='Validation Acc SGD')
plt.plot(x, bb2, label='Test Acc SGD')
plt.plot(x, b, label='Training Acc Momentum')
plt.plot(x, b1, label='Validation Acc Momentum')
plt.plot(x, b2, label='Test Acc Momentum')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision SGD-Momentum Accuracy_Graph for 1 hidden layers')
plt.plot(x, nn, label='Training Acc SGD')
plt.plot(x, nn1, label='Validation Acc SGD')
plt.plot(x, nn2, label='Test Acc SGD')
plt.plot(x, n, label='Training Acc Momentum')
plt.plot(x, n1, label='Validation Acc Momentum')
plt.plot(x, n2, label='Test Acc Momentum')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision SGD-Momentum Accuracy_Graph for 2 hidden layers')
plt.plot(x, zz, label='Training Acc SGD')
plt.plot(x, zz1, label='Validation Acc SGD')
plt.plot(x, zz2, label='Test Acc SGD')
plt.plot(x, z, label='Training Acc Momentum')
plt.plot(x, z1, label='Validation Acc Momentum')
plt.plot(x, z2, label='Test Acc Momentum')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()


plt.title('Loss comparision b/w models for Momentum Optimizer')
...
plt.title('Accuracy comparision b/w models for Momentum Optimizer')
...
plt.title('Loss comp b/w best orginal model & best model with Momentum Opt')
...
#plt.plot(x, m1, label='Validation loss for 1 hidden layer')
#plt.plot(x, m2, label='Test loss for 1 hidden layer')
plt.plot(x, y, label='Training loss for 2 hidden layer with Momentum Optimizer')
plt.plot(x, y1, label='Validation Loss for 2 hidden layer with Momentum Optimizer')
plt.plot(x, y2, label='Test Loss for 2 hidden layer with Momentum Optimizer')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()

plt.title('Accuracy comp b/w best original model & best model with Momentum Opt')
...
#plt.plot(x, n1, label='Validation Acc for 1 hidden layer')
#plt.plot(x, n2, label='Test Acc for 1 hidden layer')
plt.plot(x, z, label='Training Acc for 2 hidden layer with Momentum Optimizer')
plt.plot(x, z1, label='Validation Acc for 2 hidden layer with Momentum Optimizer')
plt.plot(x, z2, label='Test Acc for 2 hidden layer with Momentum Optimizer')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
