...
learning_rate_list = np.loadtxt('Case 2/layer2/Learning_rate_for_2_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_train_2 = np.loadtxt('Case 2/layer2/Training_loss_for_2_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_valid_2 = np.loadtxt('Case 2/layer2/Validation_loss_for_2_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_test_2 = np.loadtxt('Case 2/layer2/Test_loss_for_2_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_training_2 = np.loadtxt('Case 2/layer2/Training_acc_for_2_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_validation_2 = np.loadtxt('Case 2/layer2/Validation_acc_for_2_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_test_2 = np.loadtxt('Case 2/layer2/Test_acc_for_2_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
...
learning_rate_list = np.loadtxt('Case 2/layer1/Learning_rate_for_1_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_train_1 = np.loadtxt('Case 2/layer1/Training_loss_for_1_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_valid_1 = np.loadtxt('Case 2/layer1/Validation_loss_for_1_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_test_1 = np.loadtxt('Case 2/layer1/Test_loss_for_1_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_training_1 = np.loadtxt('Case 2/layer1/Training_acc_for_1_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_validation_1 = np.loadtxt('Case 2/layer1/Validation_acc_for_1_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_test_1 = np.loadtxt('Case 2/layer1/Test_acc_for_1_layer_sigmoid_activation_normal_Normalization_Xavier_initalization_with_n_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
...
plt.title('Comparision Relu-sigmoid Loss_Graph for 1 hidden layers')
plt.plot(x, mm, label='Training Loss relu')
plt.plot(x, mm1, label='Validation Loss relu')
plt.plot(x, mm2, label='Test Loss relu')
plt.plot(x, m, label='Training Loss sigmoid')
plt.plot(x, m1, label='Validation Loss sigmoid')
plt.plot(x, m2, label='Test Loss sigmoid')
...
plt.title('Comparision Relu-sigmoid Loss_Graph for 2 hidden layers')
plt.plot(x, yy, label='Training Loss relu')
plt.plot(x, yy1, label='Validation Loss relu')
plt.plot(x, yy2, label='Test Loss relu')
plt.plot(x, y, label='Training Loss sigmoid')
plt.plot(x, y1, label='Validation Loss sigmoid')
plt.plot(x, y2, label='Test Loss sigmoid')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision Relu-sigmoid Accuracy_Graph for 1 hidden layers')
plt.plot(x, nn, label='Training Acc relu')
plt.plot(x, nn1, label='Validation Acc relu')
plt.plot(x, nn2, label='Test Acc relu')
plt.plot(x, n, label='Training Acc sigmoid')
plt.plot(x, n1, label='Validation Acc sigmoid')
plt.plot(x, n2, label='Test Acc sigmoid')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision Relu-sigmoid Accuracy_Graph for 2 hidden layers')
plt.plot(x, zz, label='Training Acc relu')
plt.plot(x, zz1, label='Validation Acc relu')
plt.plot(x, zz2, label='Test Acc relu')
plt.plot(x, z, label='Training Acc sigmoid')
plt.plot(x, z1, label='Validation Acc sigmoid')
plt.plot(x, z2, label='Test Acc sigmoid')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()

plt.title('Loss comparision b/w models for sigmoid activation')
...
plt.title('Accuracy comparision b/w models for sigmoid activation')
...
plt.title('Loss comp b/w best orginal model & best model with sigmoid act')
...
#plt.plot(x, m1, label='Validation loss for 1 hidden layer')
#plt.plot(x, m2, label='Test loss for 1 hidden layer')
plt.plot(x, y, label='Training loss for 2 hidden layer with sigmoid act')
plt.plot(x, y1, label='Validation Loss for 2 hidden layer with sigmoid act')
plt.plot(x, y2, label='Test Loss for 2 hidden layer with sigmoid act')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()

plt.title('Accuracy comp b/w best original model & best model with sigmoid act')
...
#plt.plot(x, n1, label='Validation Acc for 1 hidden layer')
#plt.plot(x, n2, label='Test Acc for 1 hidden layer')
plt.plot(x, z, label='Training Acc for 2 hidden layer with sigmoid act')
plt.plot(x, z1, label='Validation Acc for 2 hidden layer with sigmoid act')
plt.plot(x, z2, label='Test Acc for 2 hidden layer with sigmoid act')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
