...
if __name__=='__main__':
    ...
    while(repeat==0):
        ...
        if digit=="20":
            ...
            repeat =1
        if digit=="21":
            forward_prop_for_loss_with_reg_with_relu_test()
            repeat =1
        if digit=="22":
            forward_prop_for_loss_with_no_reg_with_relu_test()
            repeat =1
        if digit=="23":
            forward_prop_for_loss_with_reg_with_sigmoid_test()
            repeat =1
        if digit=="24":
            forward_prop_for_loss_with_no_reg_with_sigmoid_test()
            repeat =1
        if digit=="25":
        ...
        if digit=="50":
            ...
            repeat =1
        if (int(digit)>50 or int(digit)<1):
