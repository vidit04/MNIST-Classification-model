...
cost_train_2 = np.loadtxt('Case 5/layer2/Training_loss_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_valid_2 = np.loadtxt('Case 5/layer2/Validation_loss_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_test_2= np.loadtxt('Case 5/layer2/Test_loss_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_training_2  = np.loadtxt('Case 5/layer2/Training_acc_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_validation_2 = np.loadtxt('Case 5/layer2/Validation_acc_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
...
acc_test_2 = np.loadtxt('Case 5/layer2/Test_acc_for_2_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
...
cost_train_1 = np.loadtxt('Case 5/layer1/Training_loss_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_valid_1 = np.loadtxt('Case 5/layer1/Validation_loss_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
cost_test_1 = np.loadtxt('Case 5/layer1/Test_loss_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_training_1 = np.loadtxt('Case 5/layer1/Training_acc_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_validation_1 = np.loadtxt('Case 5/layer1/Validation_acc_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
acc_test_1 = np.loadtxt('Case 5/layer1/Test_acc_for_1_layer_relu_activation_normal_Normalization_Xavier_initalization_with_y_regression_with_n_learning_decay_with_n_dropout_with_sgd_optimizer.csv', delimiter=',')
...
plt.title('Comparision with & without L1 reg Loss_Graph for 1 hidden layers')
plt.plot(x, mm, label='Training Loss with no L1 reg')
plt.plot(x, mm1, label='Validation Loss with no L1 reg')
plt.plot(x, mm2, label='Test Loss with no L1 reg')
plt.plot(x, m, label='Training Loss with L1 reg')
plt.plot(x, m1, label='Validation Loss with L1 reg')
plt.plot(x, m2, label='Test Loss with L1 reg')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision with & without L1 reg Loss_Graph for 2 hidden layers')
plt.plot(x, yy, label='Training Loss with no L1 reg')
plt.plot(x, yy1, label='Validation Loss with no L1 reg')
plt.plot(x, yy2, label='Test Loss with no L1 reg')
plt.plot(x, y, label='Training Loss with L1 reg')
plt.plot(x, y1, label='Validation Loss with L1 reg')
plt.plot(x, y2, label='Test Loss with L1 reg')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision with & without L1 reg Accuracy_Graph for 0 hidden layers')
plt.plot(x, bb, label='Training Acc with no L1 reg')
plt.plot(x, bb1, label='Validation Acc with no L1 reg')
plt.plot(x, bb2, label='Test Acc with no L1 reg')
plt.plot(x, b, label='Training Acc with L1 reg')
plt.plot(x, b1, label='Validation Acc with L1 reg')
plt.plot(x, b2, label='Test Acc with L1 reg')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision with & without L1 reg Accuracy_Graph for 1 hidden layers')
plt.plot(x, nn, label='Training Acc with no L1 reg')
plt.plot(x, nn1, label='Validation Acc with no L1 reg')
plt.plot(x, nn2, label='Test Acc with no L1 reg')
plt.plot(x, n, label='Training Acc with L1 reg')
plt.plot(x, n1, label='Validation Acc with L1 reg')
plt.plot(x, n2, label='Test Acc with L1 reg')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
...
plt.title('Comparision with & without L1 reg Accuracy_Graph for 2 hidden layers')
plt.plot(x, zz, label='Training Acc with no L1 reg')
plt.plot(x, zz1, label='Validation Acc with no L1 reg')
plt.plot(x, zz2, label='Test Acc with no L1 reg')
plt.plot(x, z, label='Training Acc with L1 reg')
plt.plot(x, z1, label='Validation Acc with L1 reg')
plt.plot(x, z2, label='Test Acc with L1 reg')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()

plt.title('Loss comparision b/w models with L1 reg')
...
plt.title('Accuracy comparision b/w models with L1 reg')
...
plt.title('Loss comparision b/w best orginal model & best model with L1 reg')
...
#plt.plot(x, m1, label='Validation loss for 1 hidden layer')
#plt.plot(x, m2, label='Test loss for 1 hidden layer')
plt.plot(x, y, label='Training loss for 2 hidden layer with L1 reg')
plt.plot(x, y1, label='Validation Loss for 2 hidden layer with L1 reg')
plt.plot(x, y2, label='Test Loss for 2 hidden layer with L1 reg')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()

plt.title('Accuracy comparision b/w best original model & best model with L1 reg')
...
#plt.plot(x, n1, label='Validation Acc for 1 hidden layer')
#plt.plot(x, n2, label='Test Acc for 1 hidden layer')
plt.plot(x, z, label='Training Acc for 2 hidden layer with L1 reg')
plt.plot(x, z1, label='Validation Acc for 2 hidden layer with L1 reg')
plt.plot(x, z2, label='Test Acc for 2 hidden layer with L1 reg')
#plt.plot(x, y,"b", x, y1,"g", x, y2,"r")
plt.legend()
plt.show()
