...
for i in range(10):
    ...
    acc_epoch_train = accuracy_layer_1(weights_1,baises_1,weights_2, baises_2, a, b )
    acc_epoch_valid = accuracy_layer_1(weights_1,baises_1,weights_2, baises_2, c, d )
    acc_epoch_test = accuracy_layer_1(weights_1,baises_1,weights_2, baises_2, e, f )

    loss_train = forward_prop_for_loss_layer_1(weights_1,baises_1,weights_2, baises_2, a, b , alpha ,reg, prob)
    loss_valid = forward_prop_for_loss_layer_1(weights_1,baises_1,weights_2, baises_2, c, d , alpha ,reg, prob)
    loss_test = forward_prop_for_loss_layer_1(weights_1,baises_1,weights_2, baises_2, e, f , alpha ,reg, prob)
